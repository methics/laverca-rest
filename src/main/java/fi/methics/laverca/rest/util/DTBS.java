...
public class DTBS {
    ...
    /**
     * Initialize a DTBS without a mime type for <code>toBytes()</code> This
    ...
    /**
     * Retrieve DTBS as a String - if it was a String at creation time. If the DTBS
     * was not a String, return either "-binary DTBS-" or "-llegal DTBS-" depending
     * on whether the DTBS contains binary data.
     * 
     * @return String
     */
    @Override
